...
REQUIRED_FIELDS = {"WHAT_IS_IT", "WHY_NOW", "WHY_USER_MIGHT_CARE", "WHAT_USER_ALREADY_HAS", "CAPABILITY_DELTA", "IS_IT_ACTUALLY_BETTER", "DUPLICATION", "CURRENT_NEED_MATCH", "INTEGRATION_COST", "SECURITY_RISK", "MATURITY", "BEST_ROUTE", "ACTION"}
